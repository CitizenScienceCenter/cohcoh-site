...
<template>
  <div>
      ...
      <div class="row row-centered">
        <div class="col col-large-8">
          <div class="button-group centered scroll-effect scroll-effect-delayed-2">
            ...
            <router-link tag="button" to="/cause-of-health" class="button button-primary">{{
              $t("cover-button-secondary")
            }}</router-link>
          </div>
        </div>
      </div>
          ...
          >
            <div>
              ...
              <div class="button-group centered left-aligned-large">
                <router-link tag="button" to="/cause-of-health" class="button button-secondary">{{
                  $t("cause-of-health-button")
                }}</router-link>
              </div>
            </div>
          </div>
        ...
        <div class="row row-centered row-middle row-reverse-large row-wrapping">
          ...
          >
            <div>
              ...
              <div class="button-group centered left-aligned-large">
                <router-link tag="button" to="/swiss-cohcoh" class="button button-secondary">{{
                  $t("cohcoh-button")
                }}</router-link>
              </div>
            </div>
    ...
    <app-content-section class="overflow-hidden">
      ...
      <div class="content-wrapper">
        <div class="row row-wrapping">
          <div
            class="col col-tablet-portrait-7 col-large-6 col-large-before-5 col-wrapping scroll-effect"
          >
            <h2 class="heading centered left-aligned-large">{{ $t("participate-heading") }}</h2>
            <p v-html="$t('participate-text-1')" class="reduced-bottom-margin"></p>
            <!-- <p v-html="$t('participate-text-2')" class="reduced-bottom-margin"></p>
    ...
    <section-s-d-g goal="3" color="greyish">
      This project supports Goal 3 of the UN SDGs: Ensure healthy lives and promote well-being for
      all at all ages, by accelerating and innovating in health research and development.
    </section-s-d-g>
